...
class _CrawlScreenState extends State<CrawlScreen> {
  static const double _triggerDistanceMeters = 500.0;
  ...
  void _checkForEncounters(Position position) {
    for (final result in _results) {
      ...
      if (distanceMeters <= _triggerDistanceMeters) {
        ...
        _showEncounter(result, distanceMeters);
      }
    }
  ...
  List<NearbyResult> _sortedResults() {
    final sorted = _results
        .where((result) => result.distanceKm != null)
        .toList();
  ...
  Widget build(BuildContext context) {
    final encounteredCount = _encountered.length;
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      _running
                          ? 'Watching for reviewed spots within 500 m.'
                    ...
                    if (_currentPosition != null) ...[
                      ...
                      Text(
                        'GPS: ${_currentPosition!.latitude.toStringAsFixed(5)}, '
              ...
              if (!_running)
                SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: _loading ? null : _startCrawl,
...
class _CrawlResultTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final distance = result.distanceKm ?? 0;
        ...
        subtitle: Text(
          ...
          style: TextStyle(
            color: encountered
                ...
                : Colors.white54,
            fontWeight:
                encountered ? FontWeight.w700 : null,
          ),
        ),
        trailing: const Icon(
          Icons.chevron_right,
